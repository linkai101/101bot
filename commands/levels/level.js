...
module.exports = class LevelsCommand extends Commando.Command {
    ...
    async run (message, args) {
        ...
        connection.connect(function(err) {
            ...
            if (!args.user) {
                connection.query(`SELECT * FROM experience WHERE guildID = '${message.guild.id}' AND userID = '${message.author.id}'`, function (err, result) {
                    if (err) throw err;
                ...
                connection.query(`SELECT * FROM experience WHERE guildID = '${message.guild.id}' AND userID = '${userID}'`, function (err, result) {
                    if (err) throw err;
