...
module.exports = class EnableCommand extends Command {
	...
	run(msg, args) {
		...
		if (!group) module.exports.updateMySQLRecord(msg.guild.id, args.cmdOrGrp.id);
		return msg.reply(
